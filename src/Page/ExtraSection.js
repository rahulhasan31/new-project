...
import img from '.././assets/Journey-amico.png'
      ...
      <div className="flex flex-col  overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto">
        <div className="relative lg:w-1/2">
          <img
            src={img}
            alt=""
            className=" p-10 w-full lg:absolute h-80 lg:h-full"
          />
          <svg
            className="absolute top-0 right-0 hidden h-full text-white lg:"
            viewBox="0 0 20 104"
            fill="currentColor"
          >
        ...
        <div className="flex flex-col justify-center p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2">
          ...
          <h5 className="mb-3 text-3xl font-mono font-bold leading-none sm:text-4xl">
          ...
          <p className="mb-5 text-gray-800">
            ...
            <br />
            <br />
         <span>   Ratione voluptatem.sequi nesciunt.</span>
            <br />
